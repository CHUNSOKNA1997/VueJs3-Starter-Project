...
<template>
  <section>
    <div class="container m-auto py-6 px-6">
      ...
      >
        <ArrowLeft /> <span>Back to Job Listings</span>
      </RouterLink>
    </div>
  </section>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 w-full gap-6">
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <RouterLink
              :to="`/edit-job/${jobID}`"
              class="bg-green-500 hover:bg-green-600 text-white text-center py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
              >Edit Job</RouterLink
            >
            <button
              class="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
            >
              Delete Job
            </button>
          </div>
